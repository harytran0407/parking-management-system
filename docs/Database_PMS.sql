...
CREATE TABLE PRICING_POLICY (
    ...
    SUBSEQUENT_HOURS    INT NOT NULL DEFAULT 1,       
    SUBSEQUENT_RATE     DECIMAL(10,2) NOT NULL,       
...
CREATE TABLE PAYMENT (
    ...
    PAYMENT_METHOD  ENUM('CASH','VNPAY','SUBSCRIPTION','PAYOS') NOT NULL,
...
-- ============================================================
-- NHÓM 10: NHẬT KÝ BAN NGƯỜI DÙNG
-- ============================================================
...
CREATE TABLE USER_BAN_LOG (
    ...
    CONSTRAINT FK_BAN_USER  FOREIGN KEY (TARGET_USER_ID) REFERENCES USERS(USER_ID),
    CONSTRAINT FK_BAN_ADMIN FOREIGN KEY (ACTION_BY)      REFERENCES USERS(USER_ID)
);
