...
CREATE TABLE USERS (
    ...
    PHONE       VARCHAR(15),
    ROLE_ID     INT,                         -- [FIX] Đổi từ VARCHAR(20) sang INT để liên kết với bảng ROLE
...
CREATE TABLE VEHICLE (
    ...
    VEHICLE_TYPE_ID      INT NOT NULL,                -- [FIX] Đổi VARCHAR(100) -> INT để khớp với VEHICLE_TYPE
    VEHICLE_OWNER_ID     INT NOT NULL,
    CONSTRAINT FK_VEHICLE_TYPE FOREIGN KEY (VEHICLE_TYPE_ID) REFERENCES VEHICLE_TYPE(VEHICLE_TYPE_ID), -- [FIX] Sai tên bảng tham chiếu
...
CREATE TABLE FLOOR_ZONE (
    ...
    BUILDING_ID     INT,                             
    CONSTRAINT FK_ZONE_TYPE     FOREIGN KEY (VEHICLE_TYPE_ID) REFERENCES VEHICLE_TYPE(VEHICLE_TYPE_ID), -- [FIX] Sai tên bảng tham chiếu
...
CREATE TABLE BOOKING (
    ...
    CONSTRAINT FK_BOOKING_OWNER FOREIGN KEY (VEHICLE_OWNER_ID) REFERENCES VEHICLE_OWNER(VEHICLE_OWNER_ID), -- [FIX] Thiếu dấu phẩy, sai chữ OREIGN
...
CREATE TABLE PARKING_SESSION (
    ...
    CONSTRAINT FK_SESSION_TYPE     FOREIGN KEY (VEHICLE_TYPE_ID) REFERENCES VEHICLE_TYPE(VEHICLE_TYPE_ID), -- [FIX] Sai tên bảng tham chiếu
...
CREATE TABLE PRICING_POLICY (
    ...
    VEHICLE_TYPE_ID     INT NOT NULL,
    CONSTRAINT FK_POLICY_TYPE FOREIGN KEY (VEHICLE_TYPE_ID) REFERENCES VEHICLE_TYPE(VEHICLE_TYPE_ID) -- [FIX] Sai tên bảng tham chiếu
);
