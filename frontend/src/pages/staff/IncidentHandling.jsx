...
import {
    ...
    AlertCircle, CheckCircle, Mail, Phone, Paperclip, Star
} from 'lucide-react';
...
const TABS = [
    ...
    { id: "USER_REPORTED", label: "3. User Issues", sub: "Respond & resolve user reports", icon: ClipboardList, searchBySlot: false },
];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start flex-1 min-h-0 overflow-y-auto pr-1">
                                ...
                                userIncidents.map((incident) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`bg-white dark:bg-slate-900 p-4 border rounded-md shadow-xs cursor-pointer transition-all hover:shadow-md ${
                                                isSelected
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md p-5 relative overflow-hidden h-fit space-y-4">
                        {selectedIncident ? (
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-800 p-3 rounded-md border border-slate-200 dark:border-slate-700">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className="text-xs font-black text-slate-800 dark:text-white truncate font-extrabold">
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <div className="space-y-3 text-xs">
                                            ...
                                            <div>
                                                <span className="text-[10px] font-black uppercase text-slate-450 tracking-wider block mb-0.5 font-bold">Description</span>
                                                ...
                                                <form onSubmit={handleResolveUserIncident} className="border-t border-slate-100 dark:border-slate-800 pt-3 space-y-3">
                                                    <div className="space-y-1.5">
                                                        ...
                                                        <textarea
                                                            ...
                                                            className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white font-semibold rounded-md px-3 py-2 outline-none focus:bg-white dark:focus:bg-slate-900 focus:border-slate-900 dark:focus:border-slate-400 transition-all resize-none"
                                                        />
                                                    </div>
                                                    <button
                                                        type="submit"
                            ...
                            <div className="text-center py-24 text-slate-400 dark:text-slate-500 font-medium text-xs italic space-y-2">
