...
export default function LandingPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#090f1a] text-white relative overflow-x-hidden selection:bg-blue-500/30">
      ...
      {/* 3. HERO SECTION */}
      <div id="home" className="relative z-10 max-w-7xl mx-auto px-6 pt-40 pb-16 flex flex-col items-center justify-center text-center min-h-[85vh]">
        <div className="animate-fade-in-up">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight max-w-4xl leading-[1.1] mb-8">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400">Urban Mobility</span>
          </h1>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        <div className="bg-white/5 border border-white/10 rounded-3xl overflow-hidden backdrop-blur-md shadow-2xl flex flex-col md:flex-row hover:border-blue-500/30 transition-all duration-500">
          ...
          <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center relative z-10 bg-[#090f1a] md:bg-transparent">
            <span className="text-blue-400 text-xs font-bold uppercase tracking-widest mb-3">Premium Location</span>
            <h3 className="text-3xl font-bold text-white mb-4">Smartpark Innovation Hub</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">06:00 - 23:00 Daily</p>
                </div>
              </div>
      ...
      {/* ================= SECTION: FEATURES ================= */}
      <div id="features" className="relative z-10 max-w-7xl mx-auto px-6 py-24 border-t border-white/5 mt-12">
        <div className="text-center mb-16">
          <span className="text-blue-400 text-sm font-semibold uppercase tracking-wider">System Features</span>
          <h2 className="text-3xl md:text-5xl font-bold mt-2">Cutting-Edge Solutions</h2>
        </div>
      ...
      <div id="rates" className="relative z-10 max-w-7xl mx-auto px-6 py-24 border-t border-white/5">
        <div className="text-center mb-16">
          <span className="text-indigo-400 text-sm font-semibold uppercase tracking-wider">Pricing Plans</span>
          <h2 className="text-3xl md:text-5xl font-bold mt-2">Flexible Parking Rates</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:border-white/20 transition-colors">
            ...
            <button className="w-full bg-white/10 hover:bg-white/20 text-white font-medium py-3 rounded-xl transition-colors">Select Plan</button>
          </div>
          ...
          <div className="bg-gradient-to-b from-blue-900/40 to-[#090f1a] border-2 border-blue-500 p-10 rounded-3xl relative shadow-[0_0_30px_rgba(59,130,246,0.15)] transform md:-translate-y-4">
            ...
            <p className="text-blue-200 text-sm mb-6">Ideal for sedans, SUVs, and vans</p>
            <div className="mb-8">
      ...
      {/* FOOTER (ID: about) */}
      <footer id="about" className="relative z-10 bg-[#060a12] border-t border-white/5 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <div className="text-2xl font-bold text-white tracking-tight mb-4">Smartpark</div>
            ...
            <div className="flex gap-4">
              {["Lê Nguyễn Thiên Minh", "Vũ Minh Tiến", "Huỳnh Nguyễn Bảo Khang", "Đinh Nguyễn Thịnh", "Trần Đình Quốc Hưng"].map((name, i) => (
                <div key={i} className="w-8 h-8 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-xs text-slate-400 cursor-help" title={name}>
                  {name.split(" ").pop()[0]}
                </div>
              ))}
            </div>
