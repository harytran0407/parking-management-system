    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="backdrop-blur-md bg-[#1e293b]/70 border border-slate-700/50 shadow-2xl rounded-xl p-8">
          ...
          {error && (
            <div className="mb-4 p-4 bg-red-950/50 border border-red-500/50 rounded-lg text-red-200 text-sm font-medium">
              ✕ {error}
            </div>
          )}
          ...
          <div className="mt-6 p-4 bg-slate-800/60 border border-slate-700/50 rounded-lg text-sm text-slate-300">
            <p className="font-semibold text-slate-200 mb-2">Demo Credentials:</p>
            <p className="text-slate-400">Email: <span className="text-slate-300 font-mono">demo@smartpark.com</span></p>
            <p className="text-slate-400">Password: <span className="text-slate-300 font-mono">demo123</span></p>
          </div>
        </div>
      </div>
    </div>
